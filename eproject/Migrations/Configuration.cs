namespace eproject.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<eproject.Models.context>
    {
        ...
        new User() { name = "zach",role="ROLE_ADMIN",
            enabled =true,pass= pass.HashPassword("admin1234") ,email="admin1234@gmail.com",expireDate=new DateTime(2050,12,30),gender="male",
        phone="0906767296"}
        );
           // base.Seed(context);
        }
